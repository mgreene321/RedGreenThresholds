function findIRCrossInSingleRawVideo(videoFileName, frameNums)
...
vidObj = VideoReader(fullfile(vidPath, vidFile));
...
function IRcross_XY = findIRCross(frame)
